...
This repository contains sources of a Kotlin test framework.
...
The current tasks can be found in the [open issues](https://github.com/jetbrains-academy/kotlin-test-framework/issues) in the project.
...
To build the projects with Detekt you need to run the build task.
...
- You don't have code-style problems according the [GitHub Actions](https://github.com/jetbrains-academy/kotlin-test-framework/actions/workflows/gradle-build.yml)
